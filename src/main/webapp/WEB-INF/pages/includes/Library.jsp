...
<link rel="stylesheet"
	href="<c:url value="/resources/css/famfamfam-flags.css" />" />
<link rel="stylesheet"
	href="<c:url value="/resources/css/pe-icon-7-stroke.css" />" />
<link rel="stylesheet"
...
<script type="text/javascript"
	src="<c:url value="/resources/js/jquery.ui.touch-punch.js" />"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="<c:url value="/resources/js/dataTables.searchHighlight.min.js" />"></script>
<script type="text/javascript"
